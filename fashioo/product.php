...
<section class="w3l-banner-slider-main inner-pagehny">
  ...
  <section class="w3l-content-w-photo">
        <!-- /specification-6-->
        <div class="content-photo-6-mian">
           
            <div class="container py-lg-3">
                <div class="align-photo-6-inf-cols row">
                    <div class="photo-6-inf-left col-lg-6">
                        <img src="assets/images/gc.jpg" style="height: 400px;
    width: 400px;" />
                    </div>
                     <div class="photo-6-inf-right col-lg-6">
                         <h3 class="hny-title mb-0 text-center" style="color: #ffffff">Genaral consultancy</h3>
                       <ul class="mylist text-center text-white">
                           <li><i class="fa fa-angle-double-right mr-3"></i>Hair Style Color</li>
                           <li><i class="fa fa-angle-double-right mr-3"></i>Make-Up</li>
                           <li><i class="fa fa-angle-double-right mr-3"></i>Outfits</li>
                           <li><i class="fa fa-angle-double-right mr-3"></i>@ Rs. 299 </li>
                           <li></li>
    ...
    <section id="testimonial"  class="testimonial w3l-grids-hny-2" style="font-size: 35px;">
        <!-- /content-6-section -->
        <div class="grids-hny-2-mian ">
         
        <div class="slides-wrap" style="height: 488px;">
             <div class="photo-6-inf-left col-lg-6">
                 <img src="assets/images/oc.jpg" style="height: 400px;
    width: 400px;" />
                 </div>
                
                    <div class="photo-6-inf-right col-lg-6" style="background: black;">
                        <h3 class="hny-title mb-0 text-center" style="color: #ffffff">Occasional consultancy</h3>
                     <ul class="mylist text-center text-white">
                           <li><i class="fa fa-angle-double-right mr-3"></i>Dates</li>
                           <li><i class="fa fa-angle-double-right mr-3"></i>Parties</li>
                           <li><i class="fa fa-angle-double-right mr-3"></i>Night Out</li>
                           <li><i class="fa fa-angle-double-right mr-3"></i>@ Rs. 499 </li>
                           <li></li>
                     </ul>
                    </div>
