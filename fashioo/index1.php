...
<body>
  ...
  <div class="row no-gutters occasional  bg-warning" style="    border-radius: 10px;">
    <div class="col-md-4">
      <img src="assets/images/generalimage.jpg"  alt="..." class="w3limage" style="height: 290px;">
    </div>
    <div class="col-md-8">
      <div class="card-body text-center" >
        <h5 class="card-title text-white bg-dark">GENARAL CONSULTANCY</h5>
        <ul style="list-style-type:none">
            <li><span class="span"> Hair Style Color</span></li>
            <li><span class="span"> Make-Up</span></li>
            <li  class="mb-2"><span class="span"> Outfits</span></li>
            
                <a href="https://wa.me/+919881437689" class="mt-2"> Rs. 299</a>
  ...
  <div class="card mb-3 mt-5 h-100 " >
   <div class="row no-gutters occasional bg-warning" style="border-radius: 10px;">
    <div class="col-md-8 order-md-2 order-1">
     <div class="card-body text-center ">
        <h5 class="card-title text-white bg-dark">OCCASIONAL CONSULTANCY</h5>
        <ul style="list-style-type:none" >
            <li><span class="span">Dates </span></li>
            <li><span class="span"> Parties</span></li>
            <li class="mb-2"><span class="span"> Night Out</span></li>
     ...
     <div class="col-md-4 order-md-2 order-1">
      <img src="assets/images/partyimage.jpg" alt="..." class=" w3limage"  style="height: 301px;">
    </div>
    </div>
  </div>
</div>
