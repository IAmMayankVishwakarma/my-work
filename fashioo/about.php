...
<section class="w3l-banner-slider-main inner-pagehny">
  <div class="breadcrumb-infhny">
    <div class="container-fluid">
      <marquee class="text-white font-italic font-weight-bold" behavior="scroll" direction="left">Fashion is an online fashion consultancy
        platform. We give on call fashion
        ...
        <nav class="navbar navbar-expand-lg navbar-light">
          <div class="container-fluid serarc-fluid">
            ...
            <!-- if logo is image enable this    -->
                <a class="navbar-brand" href="index.html">
                  <img src="/assets/images/logo-fashioo.png" alt="Your logo" style="height:64px;" />
                </a>
            <!--/search-right-->
    ...
    <section class="w3l-content-w-photo-6">
        ...
        <div class="content-photo-6-mian py-5">
            <h3 class="hny-title mb-0 text-center ">General consultancy</h3>
