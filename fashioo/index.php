...
<link href="https://fonts.googleapis.com/css2?family=Lobster+Two:ital@1&family=Open+Sans&family=Poppins:wght@200;300;400;500;600;700&family=Supermercado+One&display=swap" rel="stylesheet">
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    <div class="container-fluid serarc-fluid">
                        ...
                        <a class="navbar-brand" href="index.php">
                            <img src="/assets/images/logo-fashioo__1_-removebg-preview.png" alt="Your logo" style="height:83px;" />
                        </a>
                        <!--/search-right-->
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav ml-auto">
                                <li class="nav-item active" >
                                    <a class="nav-link" href="index.php" style="font-family: 'Lobster Two', cursive">Home</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#consultancy"style="font-family: 'Lobster Two', cursive">Consultant</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#about" style="font-family: 'Lobster Two', cursive">About</a>
                                </li>


                                <li class="nav-item">
                                    <a class="nav-link" href="#contact" style="font-family: 'Lobster Two', cursive">Contact</a>
                                </li>
                            </ul>
...
<!--    <div class="container mt-3" style="border:3px solid black;background:#f4f4f4;border-radius: 9px;" >-->
<!--    <div class=" mb-12" >-->
<!--  <div class="row no-gutters">-->
<!--    <div class="col-md-8">-->
<!--      <div id='home-video' class="dl-neon-vid"><center>-->
<!--    <video playsinline loop muted autoplay width="75%" style="border-right: 2px solid black;">-->
<!--                <source src="assets/video/illustration1.mp4"  />-->
<!--            </video></center>-->
<!--    </div>-->
<!--    </div>-->
<!--    <div class="col-md-4">-->
<!--      <div class="card-body">-->
        <!--<h5 class="card-title">Talk to a<br><span style="color:#eea318;"> Fashion <br></span> Stylist</h5>-->
<!--        <h5 data-aos="fade-right">Talk to a</h5>-->
<!--        <h5 style="color:#eea318;" class="text-center aos-init" data-aos="fade-right">Fashion</h5>-->
<!--        <h5 data-aos="fade-right">Stylist</h5>-->
...
<!--</section>-->
    ...
    <!--            <div id='home-video' class="dl-neon-vid"><center>-->
    <!--<video playsinline loop muted autoplay width="50%">-->
    <!--            <source src="assets/video/illustration.mp4"  />-->
    <!--        </video></center>-->
    <!--</div>-->
    ...
    <!--testimonial start-->
     <div class="container mt-5" id="consultancy">
        ...
        <div class="slides-wrap" style="height:600px !important;">
      <!--  slide 1  -->
        <div class="slide">
         <div class="testimonial-wrap">  
          ...
          <div class="col content-wrap">
            ...
            <p class="desc">Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempora, commodi. Sit veritatis, distinctio velit corrupti nesciunt sint maxime? </p>
                ...
                <div class="row">
                    ...
                    <div class="pricing-block col-lg-4 col-md-6 col-sm-12 wow fadeInUp">
                        <div class="inner-box">
                            ...
                            <div class="price-box">
                                <div class="title">GENARAL CONSULTANCY</div>
                                <h4 class="price">Rs.299</h4>
                            </div>
                            <ul class="features">
                                <li class="true"><i class="fa fa-check mr-2 mr-2" aria-hidden="true"></i>Hair Style Color</li>
                                <li class="true"><i class="fa fa-check mr-2" aria-hidden="true"></i>Make-Up</li>
                                <li class="true"><i class="fa fa-check mr-2" aria-hidden="true"></i>Outfits</li>
                               
                            </ul>
                            <div class="btn-box">
                                <a href="https://wa.me/+919881437689" class="theme-btn">BUY plan</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="pricing-block col-lg-4 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="400ms">
                        <div class="inner-box">
                            ...
                            <div class="price-box">
                                <div class="title">OCCASIONAL CONSULTANCY</div>
                                <h4 class="price">Rs.499</h4>
                            </div>
                            <ul class="features">
                                <li class="true"><i class="fa fa-check mr-2" aria-hidden="true"></i>Dates</li>
                                <li class="true"><i class="fa fa-check mr-2" aria-hidden="true"></i>Parties</li>
                                <li class="true"><i class="fa fa-check mr-2" aria-hidden="true"></i>Night Out</li>
...
<!--            <div class="button">-->
<!--               <a href="#form" class="anchor"> <button class="aboutMe">Contact us</button></a>-->
            ...
            <div class="container py-lg-5">
                <div class="text-txt row">
                    ...
                    <div class="right-side col-lg-8 pl-lg-5">
                        <h4 class="text-white";>Waiting to guide you with the help of well trained experts waiting to help you with the best of their abilities.</h4>
